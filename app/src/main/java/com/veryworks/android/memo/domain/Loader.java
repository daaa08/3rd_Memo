package com.veryworks.android.memo.domain;

import android.content.Context;
import android.util.Log;

import com.veryworks.android.memo.util.DateUtil;
...
public class Loader {
    ...
    public static final String FILE_STORAGE = "/data/data/com.veryworks.android.memo/files";
